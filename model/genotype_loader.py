...
def loader1_polars():
    ...
    #with open("/Users/jchung/Documents/GRANT/2023_11_RFA_RM_23_003_CommonFundUtility/Data/ukb_for_pgs/ukb_imp_bct_vars_merged_effects.vcf") as f:
        for line in f:
    ...
    df = pl.scan_csv(
        ...
        #"/Users/jchung/Documents/GRANT/2023_11_RFA_RM_23_003_CommonFundUtility/Data/ukb_for_pgs",
        has_header=False,
        new_columns=header,
        separator="\t",
        skip_rows=38
